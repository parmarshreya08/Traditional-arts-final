...
//       <img src={event.banner} alt={event.event_title} className="img-fluid" />
...
//       <p><strong>Bio:</strong> {event.artist_bio}</p>
//       <button className="btn btn-warning mt-3">Register Here</button>
//     </div>
//   );
// };
