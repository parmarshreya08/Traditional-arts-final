...
//       <h2 className="section-title">Traditional Indian Paintings</h2>
//       <div className="paintings-grid">
//         {paintings.map((art) => {
//           const isWishlisted = wishlistItems.some(item => item.id === art.id);
//           return(
//           <div key={art.id} className="painting-card">
//             <img src={art.image} alt={art.name} className="painting-image" />
//             <h4>{art.name}</h4>
//             <p>{art.description}</p>
...
//     price: 1150
//   },
//   // ... (Add the rest of your paintings here)
// ];
...
//               <div className="actions">
//                 <button className="add-to-cart-btn" onClick={() => handleAddToCart(art)}>
//                   Add to Cart
//                 </button>
//                 <FontAwesomeIcon
//                   icon={isWishlisted ? solidHeart : regularHeart}
    ...
    >
      ...
      {/* <motion.h2
        ...
        style={{
          ...
          fontSize: '2rem',
          fontWeight: '600',
          backgroundImage: 'url("/patterns/decorative.svg")',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center bottom',
          backgroundSize: '80% 1.5rem'
        }}
      >
          ...
          return (
            <div key={art.id} className="painting-card" data-aos="fade-up">
              ...
              {/* {userData ? (
                ...
                <button className="add-to-cart-btn" onClick={() => handleAddToCart(art)}>
                  Add to Cart
                </button>):(confirm("Kindly do login"))} */}
